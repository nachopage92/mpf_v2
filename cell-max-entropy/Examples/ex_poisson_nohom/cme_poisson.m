...
for n=1:length(Ndof)
  ...
  gPts  = sPts/nElem;         %number of Gauss points in an elcment
  inside = ones(nElem,1);
...
data_lme1  = load('normL2/normL2_lme_g0.8_GP12.mat');
Ndof_lme1  = data_lme1.Ndof;
normL2_lme1= data_lme1.normL2;

data_lme2  = load('normL2/normL2_lme_g1.8_GP06.mat');
Ndof_lme2  = data_lme2.Ndof;
normL2_lme2= data_lme2.normL2;
...
loglog(1./(Ndof_lme1-1),normL2_lme1,'mv-','markersize',10,'linewidth',2)
loglog(1./(Ndof_lme2-1),normL2_lme2,'mx-','markersize',10,'linewidth',2)
...
legend('L_2 CME','L_2 FEM','L_2 LME \gamma=0.8','L_2 LME \gamma=1.8')
